  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden bg-[#003B5C] text-white">
        ...
        <MathDeco latex="\displaystyle \sum_{i=1}^n |a_i b_i| \leq \left( \sum_{i=1}^n |a_i|^p \right)^{1/p} \left( \sum_{i=1}^n |b_i|^q \right)^{1/q}" className="bottom-12 left-[5%] text-[1.8rem]" />
