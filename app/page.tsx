  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden bg-[#003B5C] text-white">
        ...
        <MathDeco latex="\displaystyle d^2 = -a^2\Delta y \Delta z - b^2\Delta x \Delta z - c^2\Delta x \Delta y" className="top-1/2 -translate-y-1/2 left-[1%] text-[2.0rem]" />
        <MathDeco latex="\displaystyle \phi(n) = \sum_{d \mid n} \mu(d) \frac{n}{d}" className="top-1/2 -translate-y-1/2 right-[1%] text-[2.0rem]" />
