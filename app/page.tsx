  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden bg-[#003B5C] text-white">
        ...
        <MathDeco latex="v_p(x^n - y^n) = v_p(x-y) + v_p(n)" className="hidden md:block absolute top-1/2 right-[10%] text-[2.0em]" />
        ...
        <MathDeco latex="\displaystyle x^n - 1 = \prod_{d|n} \Phi_d(x)" className="absolute top-10 left-[8%] text-[2.0em]" />
